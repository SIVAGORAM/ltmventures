  ...
  return (
    <section className="w-full bg-white pt-2 sm:pt-4 pb-0 mb-0" id="brands">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
        <AnimatedSection
          className="relative rounded-3xl border border-[#FED7AA] bg-gradient-to-br from-[#FFF7ED] via-white to-[#FFEDD5]
                     px-6 md:px-10 py-8 md:py-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-0 items-center overflow-hidden shadow-sm"
        >
          {/* Brand block */}
          <div className="lg:col-span-3 lg:pr-8 lg:border-r border-[#FED7AA] flex flex-col gap-3">
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex flex-col leading-tight">
                ...
                <span className="text-[10px] font-semibold tracking-widest text-[#E67710] uppercase">
                  Wealth Management
                </span>
              </div>
            </div>
            ...
            <h3 className="font-heading font-bold text-2xl md:text-[28px] leading-tight text-[#102448]">
              Plan. Invest. <span className="text-[#E67710]">Grow.</span>
            </h3>
            ...
            <a
              ...
              className="mt-1 inline-flex items-center justify-center gap-2 self-start rounded-lg border border-[#E67710]
                         text-[#E67710] bg-white hover:bg-[#FFF7ED] px-5 py-2.5 text-sm font-semibold transition-colors group shadow-sm"
            >
            ...
            {features.map((f, i) => {
              ...
              return (
                <div key={i} className="flex flex-col items-center text-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-[#FFF7ED] border border-[#FED7AA] flex items-center justify-center">
                    <Icon className="w-5 h-5 text-[#E67710]" strokeWidth={1.75} />
                  </div>
