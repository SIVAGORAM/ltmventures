        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-6 items-center">
          ...
          <AnimatedSection className="lg:col-span-5 flex flex-col items-start gap-4 z-10 py-2 sm:py-4">
            ...
            <h2 className="font-heading font-bold text-[32px] sm:text-[42px] md:text-[48px] lg:text-[52px] leading-[1.08] text-[#102448]">
              ...
              Financial Future<span className="text-[#4F8A10]">.</span>
            </h2>
            ...
            <div className="space-y-3 sm:space-y-4 text-[#64748B] text-xs sm:text-sm md:text-base leading-relaxed max-w-[460px]">
              ...
              <p>
                Through <span className="font-bold text-[#4F8A10]">WealthyStep</span>, we aim to help individuals better understand, plan, and grow their financial future with greater clarity and confidence.
              </p>
            </div>
            
            <Link 
              href="/vision-mission"
              className="inline-flex items-center gap-2 text-[#4F8A10] font-bold text-sm sm:text-base hover:text-[#43770D] transition-colors border-b-2 border-[#4F8A10] pb-1 mt-1 sm:mt-2 group"
            >
